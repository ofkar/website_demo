...
app.config['INPUT_PHOTOS_DEST'] = '/workspace/demo-code/code/other/demo_images'
app.config['PROCESSED_PHOTOS_DEST'] = '/workspace/demo-code/code/other/task-demo-results'
app.config['PROCESSING_SCRIPT_LOCATION'] = '/workspace/demo-code/code/scaling/demo.py'
...
#def process_input_file(raw_file_name, task):
    ...
    tmpdir = '/workspace/demo-code/code/uploaded_photos/' + unique_dir
    ...
    os.path.join(fpath, cleaned_task + ext),
    "/workspace/website_demo/static/task-demo-results/" + uploadToken
    + "__" + display_name_to_task[task] + ".png")
